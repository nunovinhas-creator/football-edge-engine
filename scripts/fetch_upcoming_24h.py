"""
Fetch Upcoming Matches — próximas 24 horas.

Script standalone que vai buscar à BSD API os jogos agendados para as
próximas 24 horas e imprime-os na consola, ordenados cronologicamente.
Reutiliza `src.report.upcoming_matches.fetch_upcoming_events`/
`WINDOW_HOURS` (a mesma função e janela oficial já usadas pelo painel
"Oportunidades das Próximas 24 Horas") — nenhuma lógica de negócio nova,
...
from src.report.upcoming_matches import WINDOW_HOURS, fetch_upcoming_events
